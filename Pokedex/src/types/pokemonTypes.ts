...
export class SortingOrderPokemon extends SortingOrder {
    static readonly ALFA_ASC = new SortingOrder(
    ...
    static readonly ALFA_DESC = new SortingOrder(
    ...
    static readonly NUM_ASC = new SortingOrder(
        'Numeriek oplopend',
    ...
    static readonly NUM_DESC = new SortingOrder(
        'Numeriek aflopend',
    ...
    constructor(
        title: string,
        icon: string,
        orderingFunction: (a: PokemonDetails, b: PokemonDetails) => number
    ) {
